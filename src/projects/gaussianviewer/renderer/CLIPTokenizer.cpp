...
ReplicatedTokenizer::ReplicatedTokenizer(const std::string& merges_file_path, int ctx_len) 
...
std::array<wchar_t, 256> ReplicatedTokenizer::bytes_to_unicode() {
...
std::set<std::pair<std::wstring, std::wstring>> ReplicatedTokenizer::get_pairs(const std::vector<std::wstring>& word) {
...
std::wstring ReplicatedTokenizer::basic_clean(const std::wstring& text) {
    std::wstring result;
...
std::wstring ReplicatedTokenizer::whitespace_clean(const std::wstring& text) {
...
std::wstring ReplicatedTokenizer::bpe(const std::wstring& token) {
...
std::vector<int> ReplicatedTokenizer::encode(const std::wstring& text) {
...
std::vector<std::vector<int>> ReplicatedTokenizer::operator()(const std::vector<std::wstring>& texts, int ctx_len) {
...
int ReplicatedTokenizer::get_eot_token_id() const {
    return eot_token_id;
}